...
export interface meshopt_Bounds {
	...
	cone_apex: [number, number, number]; // float cone_apex[3];
	cone_axis: [number, number, number]; // float cone_axis[3];
...
export class Meshoptimizer {
    ...
    public static meshopt_computeMeshletBounds(
        meshlet_vertices: Uint32Array,
        meshlet_triangles: Uint8Array,
        triangle_count: number,
        ...
        WASMHelper.call(MeshOptmizer, "meshopt_computeMeshletBounds", "number",
            destination,
