...
export class BilateralFilter extends RenderPass {
    ...
    get filterSize() { return this._filterSize; }
    get blurDepthThreshold() { return this._blurDepthThreshold; }
    get blurNormalThreshold() { return this._blurNormalThreshold; }
    set filterSize(value) { this.shader.SetValue("filterSize", value); }
    set blurDepthThreshold(value) { this.shader.SetValue("blurDepthThreshold", value); }
    set blurNormalThreshold(value) { this.shader.SetValue("blurNormalThreshold", value); }
    constructor() {
        super({});
    }
