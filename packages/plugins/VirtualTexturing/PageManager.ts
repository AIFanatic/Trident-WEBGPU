...
export class PageManager {
    ...
    public ImageRequest: (request: PageRequest) => ImageData;
      ...
      constructor(virtual_size: Mathf.Vector2, page_padding: Mathf.Vector2, page_size: Mathf.Vector2, slots: { x: number, y: number } = slots_in_cache, min_pinned_lod: number = min_pinned_lod_idx) {
