// Shared: everything built on loadU32 — structs, loaders, typed indexers.
...
// Compute shaders: one writable lens, atomics included.
export const BINDLESS_COMPUTE_WGSL = `
