...
export class ThirdPersonController extends Component {
    ...
    public _animator: Components.Animator;
    ...
    private UpdateAnimation() {
        ...
        if (this.state === State.Idle) currentAnimation = this._animationIDS.idle;
        if (this.state === State.Walking) currentAnimation = this._animationIDS.walk;
