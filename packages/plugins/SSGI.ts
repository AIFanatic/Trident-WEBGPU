// From: https://cybereality.com/screen-space-indirect-lighting-with-visibility-bitmask-improvement-to-gtao-ssao-real-time-ambient-occlusion-algorithm-glsl-shader-implementation/
...
export class SSGIRenderPass extends GPU.RenderPass {
    public name: string = "SSGIRenderPass";
    ...
    private textureBlender: TextureBlender;
    ...
    public async execute(resources: GPU.ResourcePool) {
        ...
        // const ta = this.textureBlender.Process(indirectBlurred, inputLight);
