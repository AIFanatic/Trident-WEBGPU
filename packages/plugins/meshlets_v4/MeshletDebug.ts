...
class _MeshletDebug {
    private meshletsFolder: UIFolder;
    ...
    private hizFolder: UIFolder;
    private debugDepthMipLevel: UISliderStat;
    public debugDepthMipLevelValue: number = 0;
    private debugDepthExposure: UISliderStat;
    public debugDepthExposureValue: number = 0;
    private debugDepth: UIButtonStat;
    public isDebugDepthPassEnabled: boolean;

    private cullingFolder: UIFolder;
    private frustumCulling: UIButtonStat;
    private backFaceCulling: UIButtonStat;
    private occlusionCulling: UIButtonStat;
    private smallFeatureCulling: UIButtonStat;
    private dynamicLODErrorThreshold: UISliderStat;
    private dynamicLOD: UISliderStat;
    private staticLOD: UISliderStat;
