export function crc32V2(data: number[] | Uint32Array) {
...
export function toFixed(num: number, digits: number = 4): string {
    if (Object.is(num, -0)) {
...
export function crc32V2Float(data: number[] | Float32Array, precision = 4) {
    const table = (function() {
        let c;
        let table: number[] = [];
        for(let n = 0; n < 256; n++) {
...
export function checksum(data: number[] | Float32Array | Uint32Array): number {
    let sum = 0;
