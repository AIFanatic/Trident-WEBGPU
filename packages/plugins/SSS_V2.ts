import { Components, Geometry, GPU, Mathf } from "@trident/core";

export class SSS_V2 extends GPU.RenderPass {
    public name: string = "SSS_V2";
    
    private shader: GPU.Compute;
    private target: GPU.RenderTexture;
    private light: Components.Light;

    private blend: GPU.Shader;
    private blendInput: GPU.Texture;
    private blendTarget: GPU.RenderTexture;
    ...
    public async preFrame(resources: GPU.ResourcePool) {
        ...
        this.shader.SetArray("cameraData", new Float32Array([
            ...camera.viewMatrix.elements, // ViewMat : mat4x4<f32>,
            ...camera.projectionMatrix.elements, // ProjMat : mat4x4<f32>,
            ...camera.transform.position.elements, // CameraPos : vec3<f32>,
            camera.far, // Far : f32,
        ]));
