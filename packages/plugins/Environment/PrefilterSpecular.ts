...
export class PrefilterSpecular {
    ...
    constructor(res: number = 512, roughnessLevels: number = 5, outputFormat: GPU.TextureFormat = "rgba16float") {
        this.res = res;
    ...
    public Update(texture: GPU.RenderTextureCube) {
        ...
        for (let mip = 0; mip < this.roughnessLevels; mip += 1) {
            ...
            for (let face = 0; face < 6; face++) {
                ...
                this.prefilterSpecular.SetActiveLayer(face); // select array slice
