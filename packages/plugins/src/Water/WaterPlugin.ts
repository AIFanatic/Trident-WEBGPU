...
import { PassParams, RenderPassOrder } from "@trident/core/renderer/RenderingPipeline";
import { Shader } from "@trident/core/renderer/Shader";
import { ShaderLoader } from "@trident/core/renderer/ShaderUtils";
import { DepthTexture, RenderTexture, Texture } from "@trident/core/renderer/Texture";
...
class WaterRenderPass extends RenderPass {
    ...
    private albedoClone: RenderTexture;
    private depthClone: DepthTexture;
    ...
    private waterSettingsBuffer: Buffer;
