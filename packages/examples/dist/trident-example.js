...
// ../core/src/components/Component.ts
...
// ../core/src/renderer/webgpu/WEBGPURenderer.ts
...
// ../core/src/renderer/RenderGraph.ts
...
// ../core/src/renderer/webgpu/shaders/deferred/Cull.wgsl
var Cull_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/deferred/Cull.wgsl";

// ../core/src/renderer/webgpu/shaders/deferred/CullStructs.wgsl
var CullStructs_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/deferred/CullStructs.wgsl";

// ../core/src/renderer/webgpu/shaders/deferred/SettingsStructs.wgsl
var SettingsStructs_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/deferred/SettingsStructs.wgsl";

// ../core/src/renderer/webgpu/shaders/deferred/DrawIndirectGBuffer.wgsl
var DrawIndirectGBuffer_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/deferred/DrawIndirectGBuffer.wgsl";

// ../core/src/renderer/webgpu/shaders/deferred/DrawGBuffer.wgsl
var DrawGBuffer_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/deferred/DrawGBuffer.wgsl";

// ../core/src/renderer/webgpu/shaders/Blit.wgsl
var Blit_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/Blit.wgsl";

// ../core/src/renderer/webgpu/shaders/BlitDepth.wgsl
var BlitDepth_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/BlitDepth.wgsl";

// ../core/src/renderer/webgpu/shaders/DepthDownsample.wgsl
var DepthDownsample_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/DepthDownsample.wgsl";

// ../core/src/renderer/webgpu/shaders/deferred/DeferredLightingPBR.wgsl
var DeferredLightingPBR_default = "./resources/_.._/_.._/core/src/renderer/webgpu/shaders/deferred/DeferredLightingPBR.wgsl";

// ../core/src/renderer/ShaderUtils.ts
...
// ../core/src/renderer/RendererDebug.ts
...
// ../core/src/renderer/webgpu/WEBGPUBuffer.ts
...
// ../core/src/renderer/webgpu/utils/WEBGPUMipsGenerator.ts
...
// ../core/src/renderer/webgpu/WEBGPUTexture.ts
...
// ../core/src/math/BoundingVolume.ts
...
// ../core/src/renderer/webgpu/WEBGPUTimestampQuery.ts
...
// ../core/src/renderer/webgpu/WEBGPURendererContext.ts
...
// ../core/src/renderer/RendererContext.ts
...
// ../core/src/renderer/webgpu/WEBGPUTextureSampler.ts
...
// ../core/src/renderer/TextureSampler.ts
...
// ../core/src/renderer/webgpu/utils/WEBGBPUBlit.ts
...
// ../core/src/renderer/webgpu/WEBGPUBaseShader.ts
...
// ../core/src/renderer/webgpu/WEBGPUShader.ts
...
// ../core/src/utils/MemoryAllocator.ts
...
// ../core/src/renderer/passes/DeferredLightingPass.ts
...
// ../core/src/renderer/passes/TextureViewer.ts
...
// ../core/src/components/InstancedMesh.ts
...
// ../core/src/renderer/passes/DeferredShadowMapPass.ts
...
// ../core/src/renderer/passes/PrepareGBuffers.ts
...
// ../core/src/renderer/passes/DebuggerTextureViewer.ts
...
// ../core/src/renderer/passes/DeferredGBufferPass.ts
...
// ../core/src/renderer/RenderingPipeline.ts
var PassParams = {
...
// ../plugins/src/OrbitControls.ts
var _v = new math_exports.Vector3();
var OrbitControls = class {
  domElement;
  /** The center point to orbit around. Default is `0, 0, 0` */
  center = new math_exports.Vector3();
  orbitSpeed = 0.01;
  panSpeed = 10;
  enableZoom = true;
  enablePan = true;
  ...
  orbit(deltaX, deltaY) {
    ...
    const rotation = new math_exports.Quaternion().fromEuler(new math_exports.Vector3(this.y, this.x, 0));
    const position = new math_exports.Vector3(0, 0, distance).applyQuaternion(rotation).add(this.center);
...
// ../plugins/src/DataBackedBuffer.ts
...
// ../plugins/src/Water/WaterPass.wgsl
var WaterPass_default = "./resources/_.._/_.._/plugins/src/Water/WaterPass.wgsl";

// ../plugins/src/Water/WaterPlugin.ts
...
var WaterRenderPass = class extends RenderPass {
  ...
  execute(resources) {
    if (!this.initialized) return;
    const scene = components_exports.Camera.mainCamera.gameObject.scene;
    const meshes = scene.GetComponents(components_exports.Mesh);
    if (meshes.length === 0) return;
    const inputCamera = components_exports.Camera.mainCamera;
    if (!inputCamera) throw Error(`No inputs passed to ${this.name}`);
    const backgroundColor = inputCamera.backgroundColor;
...
async function Application() {
  ...
  const camera = mainCameraGameObject.AddComponent(components_exports.Camera);
  camera.SetPerspective(72, canvas.width / canvas.height, 0.05, 512);
  const controls = new OrbitControls(canvas, camera);
  {
    const lightGameObject = new GameObject(scene);
    lightGameObject.transform.position.set(-4, 4, -4);
    lightGameObject.transform.LookAtV1(new math_exports.Vector3(0, 0, 0));
    const light = lightGameObject.AddComponent(components_exports.DirectionalLight);
    light.intensity = 1;
  ...
  }
  {
    ...
    const sphereMesh = planeGO.AddComponent(components_exports.Mesh);
