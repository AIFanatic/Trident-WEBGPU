...
export class Matrix4 extends Float32Array {
    ...
    public static multiply(out: Matrix4, a: Matrix4, b: Matrix4): Matrix4 {
        let a00 = a[0],
          a01 = a[1],
          a02 = a[2],
          a03 = a[3];
    ...
    public static fromRotationTranslationScale(out: Matrix4, q: Quaternion, v: Vector3, s: Vector3): Matrix4 {
        // Quaternion math
        let x = q.x,
          y = q.y,
          z = q.z,
