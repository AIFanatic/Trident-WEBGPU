...
import Module from './meshoptimizer/MeshOptimizer.js';
...
class Meshoptimizer {
  ...
  static meshopt_computeClusterBounds(vertices, indices) {
    ...
    return {
      ...
      center: new Mathf.Vector3(boundsData[0], boundsData[1], boundsData[2]),
      // center: Vector3; // float center[3];
      radius: boundsData[3],
      // float radius;
      // /* normal cone, useful for backface culling */
      cone_apex: new Mathf.Vector3(boundsData[4], boundsData[5], boundsData[6]),
      // float cone_apex[3];
      cone_axis: new Mathf.Vector3(boundsData[7], boundsData[8], boundsData[9]),
      // float cone_axis[3];
...
export { Meshoptimizer, attribute_size };
