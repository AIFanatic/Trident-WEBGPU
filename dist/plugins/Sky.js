...
class Sky extends GPU.RenderPass {
  ...
  geometry;
  shader;
  sunDirection = new Mathf.Vector3(0, 0.035, -1);
  rayleigh = 3;
  turbidity = 10;
  mieCoefficient = 5e-3;
  mieDirectionalG = 0.7;
  ...
  async preFrame() {
    ...
    this.shader.SetArray("params", new Float32Array([
      ...this.sunDirection.elements,
      0,
      // sunPosition
      ...new Mathf.Vector3(0, 1, 0).elements,
      0,
      // up
      this.rayleigh,
      // rayleigh
  ...
  async execute() {
    ...
    GPU.RendererContext.BeginRenderPass(this.name, [{ target: this.output, clear: false }], void 0, true);
