...
class DebugTextureViewer extends GPU.RenderPass {
  name = "DebugTextureViewer";
  quadGeometry;
  shaderCube;
  shader2D;
  texture;
  ...
  async execute(resources) {
    ...
    GPU.RendererContext.BeginRenderPass(this.name, [{ target: lightingOutput, clear: true }], void 0, true);
    GPU.RendererContext.DrawGeometry(this.quadGeometry, shader);
    GPU.RendererContext.EndRenderPass();
  }
}

export { DebugTextureViewer };
