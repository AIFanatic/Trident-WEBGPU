...
class PostProcessingSMAA extends GPU.RenderPass {
  name = "SMAA";
  enabled = true;
  edgeDetectionPass;
  weightsShader;
  ...
  async execute(resources) {
    ...
    GPU.RendererContext.BeginRenderPass(this.name + " - Edge", [{ clear: true, target: this.edgeTex, color: new Mathf.Color(0, 0, 0, 1) }], void 0, true);
    ...
    GPU.RendererContext.BeginRenderPass(this.name + " - Weights", [{ clear: true, target: this.weightsTex }], void 0, true);
    ...
    GPU.RendererContext.BeginRenderPass(this.name + " - Blend", [{ clear: true, target: this.blendTex }], void 0, true);
