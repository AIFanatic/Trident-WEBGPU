...
class LODGroup extends Components.Renderable {
  ...
  static MATRICES_PER_LOD = LODGroup.DefaultCapacity;
  static MATRIX_STRIDE_BYTES = LODGroup.MATRICES_PER_LOD * 16 * 4;
  lods = [];
  matrices = new GPU.DynamicBufferMemoryAllocator(16, LODGroup.DefaultCapacity * 16);
  _instanceCount = 0;
  get instanceCount() {
...
class LODInstanceRenderable extends LODGroup {
  initialized = false;
  drawCompute;
  drawIndirectBuffer;
  lodRendererData = [];
...
export { LODGroup, LODInstanceRenderable };
