...
class FoliageMaterial extends GPU.Material {
  constructor(foliageGeometry, foliageAlbedo, foliageNormal) {
    super({ isDeferred: true });
    this.foliageGeometry = foliageGeometry;
    this.foliageAlbedo = foliageAlbedo;
    this.foliageNormal = foliageNormal;
  }
